...
class InteractiveTerminalSnapshotTest {
    ...
    fun renderInteractiveTerminalSnapshotMarksBlankScreenEmpty() {
        ...
        assertEquals(null, snapshot.cursorLineCharBeforeCursor)
        assertEquals(null, snapshot.cursorLineCharAtCursor)
        assertEquals(null, snapshot.cursorLineCharAfterCursor)
    ...
    fun renderInteractiveTerminalSnapshotIncludesCursorLineContext() {
        ...
        assertEquals(" ", snapshot.cursorLineCharBeforeCursor)
        assertEquals("w", snapshot.cursorLineCharAtCursor)
        assertEquals("o", snapshot.cursorLineCharAfterCursor)
    ...
    fun renderInteractiveTerminalSnapshotReportsCursorLineWhitespaceBounds() {
        ...
        assertEquals("e", snapshot.cursorLineCharBeforeCursor)
        assertEquals(null, snapshot.cursorLineCharAtCursor)
        assertEquals(null, snapshot.cursorLineCharAfterCursor)
    ...
    fun renderInteractiveTerminalSnapshotReportsCursorLineRegionBeforeAndAfterText() {
        ...
        assertEquals(" ", beforeText.cursorLineCharBeforeCursor)
        assertEquals(" ", beforeText.cursorLineCharAtCursor)
        assertEquals(" ", beforeText.cursorLineCharAfterCursor)
        ...
        assertEquals(" ", atTextStart.cursorLineCharBeforeCursor)
        assertEquals("m", atTextStart.cursorLineCharAtCursor)
        assertEquals("i", atTextStart.cursorLineCharAfterCursor)
        ...
        assertEquals("e", afterText.cursorLineCharBeforeCursor)
        assertEquals(null, afterText.cursorLineCharAtCursor)
        assertEquals(null, afterText.cursorLineCharAfterCursor)
