...
fun ChatPage(id: Uuid, text: String?, files: List<Uri>, nodeId: Uuid? = null) {
    ...
    // Hide keyboard and clear chat input focus when drawer is open.
        ...
        Scaffold(
            ...
            bottomBar = {
                ChatInput(
                    ...
                    currentSendTokensProvider = { vm.estimateCurrentPromptTokens() },
                    onCancelClick = {
                        vm.stopGeneration()
                    },
            ...
            ChatList(
                ...
                onDeletePreviewSelectedNodes = { nodeIds ->
                    if (loadingJob != null) {
                        vm.showDeleteBlockedWhileGeneratingError()
                    } else {
                        vm.deleteMessageNodes(nodeIds)
                    }
                },
                onUndoPreviewDelete = {
                    vm.undoLastDelete()
